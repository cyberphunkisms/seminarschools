...
for(const [name,needle,where] of [
 ...
 ['prepaint hydration marker','classList.add("pm-ui-ready")',app],['Details-first card action','class="pm-action primary-link"',app],['separate exact destination action','class="pm-action pm-source-action"',app],['destination contract guard','event.destination_status === "unavailable-specific-page"',app],['destination action hostname','pm-source-domain',app],['technical hostname wrap opt-in','data-allow-word-break="true"',app],['official event wording','openEventPage:',app],['source event wording','openEventSourcePage:',app],['compact listing kind','class="pm-chip-list"',main],['data summary','id="pmDataUpdated"',main],['related Commons paths','class="pm-related-paths"',main],['payload-driven summary','renderDataSummary(loaded.payload, loaded.raw.length)',app],['visible deadline labels','class="pm-date-box deadline"',app],['confirmed event precedence','if (confirmedDatedEvent) return "attend";',app]
