...
OUT = ROOT / "data" / "polymythcal-audit36"
...
with sync_playwright() as p:
    ...
    print("AUDIT36 desktop start", flush=True)
    ...
    context.close()
    print("AUDIT36 desktop complete", flush=True)

    # French interface and dynamic labels.
    print("AUDIT36 French start", flush=True)
    ...
    context.close()
    print("AUDIT36 French complete", flush=True)
    ...
    print("AUDIT36 mobile start", flush=True)
    ...
    print("AUDIT36 mobile complete", flush=True)

    # Forced-colour resilience.
    print("AUDIT36 forced-colour start", flush=True)
