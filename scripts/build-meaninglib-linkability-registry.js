...
const explicit = [
  ...
  ['contentinternet', ['contentinternet', 'ContentInternet', 'Content Internet']],
  ['contentinternet-idiomary', ['Contentinternet Idiomary', 'Content Internet Idiomary']],
  ['year-of-the-snakes', ['The Year of the Snakes', 'Year of the Snakes', 'yearofthesnakes']],
  ['polymyth-carrd', ['Polymyth Carrd', 'polymyth.carrd.co', 'Polymyth Portal']],
  ['denote', ['DENOTE', 'Denote']],
  ['idiomanalyses', ['idiomanalyses', 'idiomanalysis', 'Idiom Analyses']],
  ['polymorphousmythology', ['polymorphousmythology', 'PolymorphousMythology', 'polymorphous mythology', 'polymorphous-mythology']],
  ['egregorewars', ['egregorewars', 'EgregoreWars', 'egregore wars']],
  ['archivalchemy', ['Archivalchemy', 'archivalchemy']],
  ['antimedia', ['Antimedia', 'anti-media']],
  ['black-hole-of-devaluation', ['Black Hole of Devaluation', 'black hole of devaluation']],
  ['collective-ritual', ['Collective Ritual', 'collective ritual']],
  ['dark-magic', ['Dark Magic', 'dark magic']],
  ['dark-magic-creation', ['Dark Magic Creation', 'dark magic creation']],
  ['edgelord', ['Edgelord', 'edgelord']],
  ['fellowship', ['Fellowship', 'fellowship']],
  ['logos-awakening', ['Logos Awakening', 'logos awakening']],
  ['normalize', ['Normalize', 'normalize']],
  ['phoenix-rebirth', ['Phoenix Rebirth', 'phoenix rebirth']],
  ['reverse-vanguard', ['Reverse Vanguard', 'reverse vanguard']],
  ['snake-seeing', ['Snake-Seeing', 'snake seeing', 'snake-seeing']],
  ['snake-seer', ['Snake-Seer', 'snake seer', 'snake-seer']],
  ['snake-symbolism', ['Snake Symbolism', 'snake symbolism']],
  ['gorgon-matrix', ['The Gorgon Matrix', 'Gorgon Matrix', 'gorgon matrix']],
  ['unnecessaryplug', ['UnnecessaryPlug', 'unnecessary plug']],
  ['witcher-code', ['Witcher Code', 'witcher code']],
  ['witcher-neutrality', ['Witcher Neutrality', 'witcher neutrality']],
  ['witcher', ['Witcher', 'Witchers', 'witcher', 'witchers']],
  ['witch', ['Witch', 'Witches', 'witch', 'witches']],
  ['witch-gorgon', ['Witch Gorgon', 'Witch Gorgons', 'witch-gorgon', 'witch gorgon']],
  ['wizard', ['Wizard', 'Wizards', 'wizard', 'wizards']],
  ['medusa-2020', ['Medusa (2020)', 'Medusa 2020']],
  ['categorization-bias', ['Categorization Bias', 'categorization bias']],
  ['rent-free', ['rent-free', 'rent free']],
  ['tiny-ouroboros', ['Tiny Ouroboros', 'tiny ouroboros']],
  ['deep-ouroboros', ['Deep Ouroboros', 'deep ouroboros']],
  ['one-ouroboros', ['The One Ouroboros', 'One Ouroboros', 'Long Ouroboros', 'Long Snake']],
  ['timestamped-virtue-signaling', ['Timestamped Virtue Signaling', 'timestamped virtue signaling']],
  ['gorgonification-loop', ['Gorgonification Loop', 'gorgonification loop']],
  ['performative-progress', ['Performative Progress', 'performative progress']],
  ['counteridiom', ['Counteridiom', 'Counteridioms', 'counter-idiom', 'counteridioms']],
  ['historical-revisionism', ['Historical Revisionism', 'historical revisionism']],
  ['agoraikon', ['Agoraikon', 'Agoraikons', 'agoraikon', 'agoraikons']],
  ['archonanalysis', ['ArchonAnalysis', 'ArchonAnalyses', 'archon analysis', 'archon analyses']],
  ['archon', ['Archon', 'Archons', 'archon', 'archons']],
  ['meta-consistent-logic', ['MetaConsistentLogic', 'Meta-Consistent Logic', 'meta consistent logic']],
  ['hegelianegirl', ['Hegelianegirl', 'Hegelian e-girl', 'Hegelian e-girls', 'hegelianegirls']],
  ['journeyman', ['Journeyman', 'Journeymen', 'journeyman', 'journeymen']],
  ['true-journeyman', ['True Journeyman', 'True Journeymen']],
  ['false-journeyman', ['False Journeyman', 'False Journeymen']],
  ['tragic-journeyman', ['Tragic Journeyman', 'Tragic Journeymen']],
  ['perpetual-journeyman', ['Perpetual Journeyman', 'Perpetual Journeymen']],
  ['anti-journeyman', ['Anti-Journeyman', 'Anti-Journeymen', 'Anti Journeyman', 'Anti Journeymen']],
];
