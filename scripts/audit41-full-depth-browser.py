#!/usr/bin/env python3
"""Audit 41 browser depth pass for heading, density, and event rollover continuity."""
...
def main() -> None:
    ...
    if release.get("release_id") != RELEASE_ID:
        raise SystemExit(
            "AUDIT 41 DEPTH FAILED — apply the Audit 41 release stamp before browser evidence"
        )
