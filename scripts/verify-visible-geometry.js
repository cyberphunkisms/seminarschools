...
console.log(`VISIBLE GEOMETRY CHECK PASSED — ${source.length} source and ${deployed.length} public HTML webpages carry alive.css, mandala.js, indra.js, valid intensity markers and deployable route parity; CV pages remain included.`);
