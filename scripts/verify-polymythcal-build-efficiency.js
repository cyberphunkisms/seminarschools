...
const requiredBuildSteps=[
  ...
  "node scripts/run-python.js scripts/update-polymythcal-editable-master-set9-2026-08-13.py",
  "node scripts/run-python.js scripts/update-polymythcal-editable-master-sets10-11-2026-08-14.py",
  "node scripts/run-python.js scripts/update-polymythcal-editable-master-set12-2026-08-14.py",
  "node scripts/run-python.js scripts/update-polymythcal-editable-master-set14-2026-08-15.py",
  "node scripts/run-python.js scripts/update-polymythcal-editable-master-sets13-15-2026-08-15.py",
