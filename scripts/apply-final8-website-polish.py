...
def patch_accessibility_and_links() -> None:
    ...
    rels = [
        ...
        *[f'polymyth/devilsdiary/{i}/index.html' for i in range(1,9)],'polymyth/devilsdiary/replies/index.html','polymyth/devils-notebook/the-boy-and-the-earworm/index.html','polymyth/archive/pre-meaninglib/index.html',
