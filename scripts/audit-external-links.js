...
fs.writeFileSync(path.join(outDir,'external-link-inventory.json'), JSON.stringify({schema:'external-link-inventory-v1',generatedAt:new Date().toISOString(),totalExternalLinks:total,topHosts:top,importantSample:important.slice(0,500)},null,2));
