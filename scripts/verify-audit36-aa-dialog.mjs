...
if (failures.length) {
  console.error('AUDIT36 AA DIALOG FAILED');
  for (const failure of failures) console.error(`- ${failure}`);
  process.exit(1);
}

console.log('AUDIT36 AA DIALOG PASSED — persistent panel, modal semantics, focus trap/return, inert background, and unified renderer cleanup.');
