...
if (!fs.existsSync(PUBLIC)) {
  console.error('AUDIT 40 CONTENT STRUCTURE FAILED — public/ is missing; run the canonical build first.');
  process.exit(1);
}
...
if (failures.length) {
  console.error('AUDIT 40 CONTENT STRUCTURE FAILED');
...
console.log(
  'AUDIT 40 CONTENT STRUCTURE PASSED — '
