...
OUTPUT_NAME = "seminar-schools-geometry-motion-complete-2026-09-07.zip"
RELEASE = {
...
def main() -> None:
    ...
    required = {
        "GEOMETRY_MOTION_2026-09-07.md",
        "SITE_PACKAGE/scripts/package-motion-successor.py",
        "SITE_PACKAGE/scripts/verify-motion-archive.py",
        "SITE_PACKAGE/scripts/fixtures/geometry-motion-harness.html",
        "SITE_PACKAGE/scripts/fixtures/geometry-motion-baseline.js",
    ...
    run([
        sys.executable,
        "scripts/verify-motion-archive.py",
        str(output),
    ])
    print(json.dumps({
        "archive": str(output),
