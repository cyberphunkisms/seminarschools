...
with sync_playwright() as p:
    ...
    print("AUDIT37 desktop start", flush=True)
    ...
    context.close()
    print("AUDIT37 desktop complete", flush=True)

    # French interface and dynamic labels.
    print("AUDIT37 French start", flush=True)
    ...
    context.close()
    print("AUDIT37 French complete", flush=True)
    ...
    print("AUDIT37 mobile start", flush=True)
    ...
    print("AUDIT37 mobile complete", flush=True)

    # Forced-colour resilience.
    print("AUDIT37 forced-colour start", flush=True)
