...
1. [readme] Meaninglib (195.14)
   - hf_export/README.md
2. [ml] Meaninglib (mother-category for all * files, scanner-tier of polymyth) (86.45)
   - hf_export/data/all_meaninglib_rows.jsonl
3. [ml] core* (memory-tier * file, cross-session behavioral rules) (64.64)
   - hf_export/data/all_meaninglib_rows.jsonl
4. [ml] Pedagogical ontology (63.86)
   - hf_export/data/all_meaninglib_rows.jsonl
...
2. [ml] CL-60 INTERDEPENDENT DEFINITION — define each element by its own function and its interlock, never by ordinal or list-position (2026-06-14) (150.47)
   - hf_export/data/all_meaninglib_rows.jsonl
3. [ml] Meaninglib (mother-category for all * files, scanner-tier of polymyth) (127.75)
   - hf_export/data/all_meaninglib_rows.jsonl
4. [ml] JAZZ rule (folds Modularity rule and Interdependency rule into both-at-once name) (98.22)
   - hf_export/data/all_meaninglib_rows.jsonl
5. [mc] ml* deep reading — canonical-source discipline (88.60)
   - hf_export/data/all_meaninglib_rows.jsonl
...
1. [readme] Meaninglib (410.31)
   - hf_export/README.md
2. [ml] T118 AND THE GAMEWORLD SET RELOCATED TO bb* (Rainbowsol-directed 2026-06-06) (197.67)
   - hf_export/data/all_meaninglib_rows.jsonl
...
2. [ml] Psychologism (87.23)
   - hf_export/data/all_meaninglib_rows.jsonl
3. [ml] Psychologism gorgon culture, DSM hydra as gorgonwars within egregorewars (77.68)
   - hf_export/data/all_meaninglib_rows.jsonl
...
1. [bb] BBT category stub: therapy branch of BookwormBurrows (144.78)
   - hf_export/data/all_meaninglib_rows.jsonl
2. [bb] BB / BookwormBurrows / PolymythDND naming alias and anti-TWIST rule choice (137.24)
   - hf_export/data/all_meaninglib_rows.jsonl
3. [bb] Rainbowsol is Saul, the founder (105.11)
   - hf_export/data/all_meaninglib_rows.jsonl
4. [bb] Worldmoot is big-group play (103.93)
   - hf_export/data/all_meaninglib_rows.jsonl
5. [bb] Question the frame (103.30)
   - hf_export/data/all_meaninglib_rows.jsonl
...
1. [mc] mc* concept-primary architecture (148.85)
   - hf_export/data/all_meaninglib_rows.jsonl
2. [mc] mc* alignment methodology (146.88)
   - hf_export/data/all_meaninglib_rows.jsonl
3. [mc] mc* curriculum_anchor schema (145.86)
   - hf_export/data/all_meaninglib_rows.jsonl
4. [mc] mc* curriculum-map decisions, May 2026 (145.05)
   - hf_export/data/all_meaninglib_rows.jsonl
5. [mc] mc* concept inventory (Pass B manifest) (142.86)
   - hf_export/data/all_meaninglib_rows.jsonl
...
3. [cc] cmp-001 Street block detail template (cc* hyperrealism scaffold) (130.99)
   - hf_export/data/all_meaninglib_rows.jsonl
4. [cc] cc* render defect: 116 entries carry s values outside the five rendered tabs (pass-3 CL capture 2026-06-06) (130.26)
   - hf_export/data/all_meaninglib_rows.jsonl
